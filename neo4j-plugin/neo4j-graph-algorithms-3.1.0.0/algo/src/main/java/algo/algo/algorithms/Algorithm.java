...
public class Algorithm implements AlgoIdGenerator {
    ...
    // TODO these methods are of interest for changing the weights
    private int loadRelationships(String relCypher, boolean weighted, int defaultWeight) {
        ...
        // TODO this line may be of interest in updating the weights
        ...
        // TODO figure out how to do the mergeChunks to combine all avgCitations (one per batch) into one avg
    ...
    private int loadRelationshipsBatch(String relCypher, boolean weighted, int defaultWeight, int batchSize, int threads) {
        ...
        for (RelationshipLoader loader : loaders) {
            // TODO this line may be of interest
            loader.transformRelData(relationshipTargetChunks, relationshipWeightChunks, offsetTracker);
        }
    ...
    private static class RelationshipLoader implements Result.ResultVisitor<RuntimeException> {
        ...
        // Sets all the weights to zero and makes sourceDegreeData vector
        // (len nodeCount) empty also
        ...
        // This method visits each node, increase totalRelt count,
        // makes sure node has an id, sets weight, setes new source and target
        // It also increments sourceDegreeData and relData.set() index and target
        // TODO this method is of interest for getting the weights changed
        @Override
        ...
        // TODO This method does the same thing as the other one but also with weights
        // TODO this method is of interest for updating the weights
        private void transformRelationshipDataToOffsetStorage(Chunks relData, int relDataIdx, PrimitiveLongIntMap weights, Chunks relationshipTarget, Chunks relationshipWeight, int[] offsetTracker) {
            ...
            for (int i=0;i<relDataIdx;i++) {
                ...
                if (id < 0) {
                    ...
                    // TODO this weight needs to be update I think
